...
impl DelayManager {
    ...
    pub fn update(
        ...
        let mut registered_delay = false;
        ...
        // The histogram's initial distribution is not an observation. Preserve
        // the configured start delay until the first resampling interval has
        // produced a real delay sample.
        if registered_delay {
